...
function ReviewColumn({
  reviews, // basically, phones (and not "reviews" reviews)
  className,
  reviewClassName,
  msPerPixel = 0, // at what speed will the elements move
}: {
  reviews: string[];
  className?: string;
...
function Review({ imgSrc, className, ...props }: ReviewProps) {
  ...
  return (
    <div
      className={cn(
        "animate-fade-in rounded-[2.25rem] bg-white p-6 opactiy-0 shadow-xl shadow-slate-900/5",
        className
      )}
