...
const Page = () => {
  ...
  const onDropRejected = (rejectedFiles: FileRejection[]) => {
    const [file] = rejectedFiles; // destructuring the FileRejection array & accessing the first rejected file
  ...
  return (
    <div
      className={cn(
        "relative flex flex-col flex-1 items-center justify-center w-full h-full my-16 bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 rounded-xl lg:rounded-2xl",
    ...
    >
      <div className="relative flex flex-col flex-1 items-center justify-center w-full">
        <Dropzone
          ...
          accept={{
            // defining key-value pairs for accepted image-types(extensions):
            "image/png": [".png"],
            "image/jpeg": [".jpeg"],
            "image/jpg": [".jpg"],
          }}
